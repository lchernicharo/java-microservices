...
import br.com.tech4me.animaisms.service.AnimalService;
import br.com.tech4me.animaisms.view.model.AnimalModeloAlteracao;
import br.com.tech4me.animaisms.view.model.AnimalModeloInclusao;
import br.com.tech4me.animaisms.view.model.AnimalModeloResponse;
...
public class AnimalController {
    ...
    @GetMapping(value="/dono/{dono}/animais")
    ...
    @KafkaListener(topics = "${api.async.animais.incluir.topic.name}")
    void adicionarAnimalAsync(AnimalAsyncModel animal) {
        service.criarAnimal(new ModelMapper().map(animal, AnimalDto.class));
    }
}
